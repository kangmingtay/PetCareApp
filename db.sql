...
CREATE TABLE IF NOT EXISTS Bids (
    ...
    review VARCHAR(256), 
    PRIMARY KEY(pname, pet_id, cname, date),
    FOREIGN KEY (pname, pet_id) REFERENCES Pets(pname, pet_id) ON DELETE CASCADE,
    FOREIGN KEY (cname, date) REFERENCES Schedule(cname, date) ON DELETE CASCADE
);