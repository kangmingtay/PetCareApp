...
export default {
    ...
    postNotWorking: (username) => `${BASE_URL}/caretakers/requestDays/${username}`,
    getLeaves: (username) => `${BASE_URL}/caretakers/leaves/${username}`,
    getAvailability: (username) => `${BASE_URL}/caretakers/availability/${username}`,
    deleteNotWorking: (username) => `${BASE_URL}/caretakers/requestDays/${username}`,
    getCareTakerRating: (username) => `${BASE_URL}/caretakers/rating/${username}`,
